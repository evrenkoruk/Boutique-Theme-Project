<?php @session_start(); @ob_start();
  ...
  if($islem == "duzenle"){
     ...
     $kontrol = $wo_db->prepare("SELECT * FROM haberler WHERE id = :id");
      ...
      if($say > 0){
        ...
        header("Location: admin.php?p=haberler");
      }
...
<?php
  ...
  if($islem == "ekle"){
    ...
    <div class="row">
      ...
      <form role="form" class="form-horizontal"  id="forms" name="forms" method="POST" action="ajax.php?p=haberler/haber_ekle" onsubmit="return false;" enctype="multipart/form-data">
          ...
          <div class="ibox-content collapse in">
            <div class="widgets-container">
              ...
              <div class="form-group">
                ...
                <input class="form-control" placeholder="Haber Başlığı" type="text" name="baslik" id="baslik">
                </div>
              </div>
    ...
    <div class="row">
      ...
      <form role="form" class="form-horizontal"  id="forms" name="forms" method="POST" action="ajax.php?p=haberler/haber_duzenle" onsubmit="return false;" enctype="multipart/form-data">
          ...
          <div class="ibox-content collapse in">
            <div class="widgets-container">
              ...
              <div class="form-group">
                <div class="input-icon">
                <i class="fa fa-edit"></i>
                <input class="form-control" placeholder="Haber Başlığı" type="text" name="baslik" id="baslik" value="<?=$d_baslik;?>">
                </div>
              </div>
            ...
            <div class="widgets-container" style="overflow: hidden;">
              <div>
                  ...
                  <?php
                    ...
                    $gorseller = $wo_db->query("SELECT * FROM gorseller WHERE yazi_id='$id' and kategori='haber' order by id DESC", PDO::FETCH_ASSOC);
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        <a class="btn aqua btn-lgy" href="admin.php?p=haberler&islem=ekle"><i class="fa fa-plus"> </i> Yeni Haber Ekle </a>
        <div class="ibox float-e-margins">
          <div class="ibox-title">
            <h5>HABERLER</h5>
              ...
              <div>
                <table id="example" class="table  responsive nowrap table-bordered" cellspacing="0" width="100%">
                  ...
                  <?php
                    ...
                    $haberler = $wo_db->query("SELECT * FROM haberler order by tarih DESC", PDO::FETCH_ASSOC);
                    if ( $haberler->rowCount()){
                          ...
                          echo '
                            <tr id="veri'.$row["id"].'">
                              ...
                              <td id="tablo_yazi" style="width:40px; text-align: center;">
                                <a class="btn aqua" href="admin.php?p=haberler&islem=duzenle&id='.$row["id"].'"><i class="fa fa-edit"></i> Düzenle</a>
                                ';
                                ?>
                                <button class="btn btn-danger" data-toggle="modal" data-target="#veri_sil" onclick="veri_sil('<?=$row["baslik"];?>','haber','<?=$row["id"];?>');"><i class="fa fa-close"></i> Sil</button>
                              <?
                              echo '</td>
                            </tr>
                          ';
