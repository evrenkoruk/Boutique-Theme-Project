<?php @session_start(); @ob_start();
  ...
  if($islem == "duzenle"){
     ...
     $kontrol = $wo_db->prepare("SELECT * FROM anlasmali_kurumlar WHERE id = :id");
      ...
      if($say > 0){
        ...
        header("Location: admin.php?p=anlasmali_kurumlar");
      }
...
<?php
  ...
  if($islem == "ekle"){
    ...
    <div class="row">
      ...
      <form role="form" class="form-horizontal"  id="forms" name="forms" method="POST" action="ajax.php?p=anlasmali_kurumlar/kurum_ekle" onsubmit="return false;" enctype="multipart/form-data">

      <div class="col-lg-9">

        <div class="ibox float-e-margins">
          <div class="ibox-title">
            <h5>ANLAŞMALI KURUM EKLE</h5>
          ...
          <div class="ibox-content collapse in">
            <div class="widgets-container">
              ...
              <div class="form-group">
                ...
                <input class="form-control" placeholder="Anlaşmalı Kurum Adı" type="text" name="baslik" id="baslik">
                </div>
              </div>
            ...
            <div class="widgets-container">
              <div>
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="Kurum Görselleri" name="gorseller[]" id="gorseller[]" type="file" multiple="multiple">
                  </div> 
                </div>
    ...
    <div class="row">
      ...
      <form role="form" class="form-horizontal"  id="forms" name="forms" method="POST" action="ajax.php?p=anlasmali_kurumlar/kurum_duzenle" onsubmit="return false;" enctype="multipart/form-data">
      <input type="hidden" name="id" id="id" value="<?=$_GET["id"];?>">
      <div class="col-lg-9">

        <div class="ibox float-e-margins">
          <div class="ibox-title">
            <h5>ANLAŞMALI KURUM DÜZENLE</h5>
          ...
          <div class="ibox-content collapse in">
            <div class="widgets-container">
              ...
              <div class="form-group">
                <div class="input-icon">
                <i class="fa fa-edit"></i>
                <input class="form-control" placeholder="Anlaşmalı Kurum Adı" type="text" name="baslik" id="baslik" value="<?=$d_baslik;?>">
                </div>
              </div>
            ...
            <div class="widgets-container" style="overflow: hidden;">
              <div>
                  ...
                  <?php
                    ...
                    $gorseller = $wo_db->query("SELECT * FROM gorseller WHERE yazi_id='$id' and kategori='kurum' order by id DESC", PDO::FETCH_ASSOC);
                    if ( $gorseller->rowCount()){
                      ...
                      echo 'Habere ait görsel bulunamadı';
                    }
            ...
            <div class="widgets-container">
              <div>
                <div class="form-group">
                  <div class="input-icon">
                  <i class="fa fa-upload"></i>
                  <input class="form-control" placeholder="Haber Görselleri" name="gorseller[]" id="gorseller[]" type="file" multiple="multiple">
                  </div> 
                </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        <a class="btn aqua btn-lgy" href="admin.php?p=anlasmali_kurumlar&islem=ekle"><i class="fa fa-plus"> </i> Yeni Kurum Ekle </a>
        <div class="ibox float-e-margins">
          <div class="ibox-title">
            <h5>ANLAŞMALI KURUMLAR</h5>
              ...
              <div>
                <table id="example" class="table  responsive nowrap table-bordered" cellspacing="0" width="100%">
                  ...
                  <?php
                    ...
                    $anlasmali_kurumlar = $wo_db->query("SELECT * FROM anlasmali_kurumlar order by id DESC", PDO::FETCH_ASSOC);
                    if ( $anlasmali_kurumlar->rowCount()){
                         foreach( $anlasmali_kurumlar as $row ){
                          ...
                          echo '
                            <tr id="veri'.$row["id"].'">
                              ...
                              <td id="tablo_yazi" style="width:40px; text-align: center;">
                                <a class="btn aqua" href="admin.php?p=anlasmali_kurumlar&islem=duzenle&id='.$row["id"].'"><i class="fa fa-edit"></i> Düzenle</a>
                                ';
                                ?>
                                <button class="btn btn-danger" data-toggle="modal" data-target="#veri_sil" onclick="veri_sil('<?=$row["baslik"];?>','anlasmali_kurumlar','<?=$row["id"];?>');"><i class="fa fa-close"></i> Sil</button>
                              <?
                              echo '</td>
                            </tr>
                          ';
