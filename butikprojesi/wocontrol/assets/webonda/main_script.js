function bastim(){
$.isLoading({ text: "<img src='assets/images/ajax-loader.gif'>" });
}
...
function AjaxFormS(FORMID,SONUCID){
 ...
 for(var forms in CKEDITOR.instances)
 CKEDITOR.instances[forms].updateElement();
...
function AjaxFormW(FORMID,SONUCID){
